...
INTEGER, PLUS, MINUS, MUL, DIV, LPAREN, RPAREN, EOF, BEGIN, END, ID, DOT, ASSIGN, SEMI = (
    'INTEGER', 'PLUS', 'MINUS', 'MUL', 'DIV', '(', ')', 'EOF', 'BEGIN', 'END', 'ID', 'DOT', 'ASSIGN', 'SEMI'
)
...
class Interpreter(NodeVisitor):
    def __init__(self, parser: Parser):
        self.parser = parser
        self.GLOBAL_SCOPE: Dict[str: AST] = dict()
